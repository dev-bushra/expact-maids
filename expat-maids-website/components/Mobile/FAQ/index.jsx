...
function FAQ() {
    const [isArrowUpOrDown, SetIsArrowUpOrDown] = useState([0, 0, 0, 0, 0]);
        ...
        <div className={styles.faqWrapper} id="faqs">
            ...
            <Accordion flush className={styles.accordion}>
                ...
                <Card className={styles.accordionCard}>
                    ...
                    >
                    <Card.Body className={styles.accordionBody}>
                    Travelling with your maid to other countries is hassle-free with us, as our employment letter is generally accepted by most embassies. Additionally, we provide free of charge no objection certificates (NOCs) for travel purposes.                    </Card.Body>
                    </Accordion.Collapse>
                </Card>
                <div className={styles.divider}></div>
                <Card className={styles.accordionCard}>
                ...
                <Card className={styles.accordionCard}>
                    ...
                    >
                    <Card.Body className={styles.accordionBody}>
                        WCompared to individual sponsorship, we only require a minimal set of documents from you. All you need to provide us with is a copy of your passport, visa, and Emirates ID.
                    </Card.Body>
                    </Accordion.Collapse>
                </Card>
                <div className={styles.divider}></div>
