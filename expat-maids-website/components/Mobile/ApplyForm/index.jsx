...
function Banner() {
    ...
    const handleSubmit = async (e) => {
        ...
        if ( photograph == "" || passport == "" ) {
        toast.error("Please Give Mandatory Fields.", {
            position: "bottom-center",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
        ...
        // toast.success("Your application has send successfully!", {
        //     position: "bottom-center",
        //     autoClose: 3000,
        //     hideProgressBar: false,
        //     closeOnClick: true,
...
return (
    <Container fluid className={styles.applyWrapper}>
        ...
        {/* <Row className={styles.row1}>
            <h1 className={styles.header}>Visa Sponsorship Application</h1>
        </Row> */}

        {/* Steps Card */}
        <Row className={styles.stepCardsRow}>
        ...
        {/* Steps Card + 2 Step Form  */}
        <Row className={styles.row2}>
            <Col md={12} className={styles.row2Col1}>
                <Form className={styles.form}>
                    { step == 1 ? 
                        ...
                        <Col md={4} className={styles.formCol}>
                            ...
                            <small style={{ fontSize: "12px", marginLeft: "10px" }}>(if available)</small>
                            </Form.Label>
                            <Form.Group
                        ...
                        <Col md={4} className={styles.formCol}>
                            <Form.Label className={styles.label}>
                            Police Clearance
                            <small style={{ fontSize: "12px", marginLeft: "10px" }}>(for african nationals only)</small>
                            </Form.Label>
                            <Form.Group
                    ...
                    <Row className={styles.actionBtnRow}>
                            ...
                            <div className={styles.twoBtnContainer}>
                                <div className={styles.backBtn} onClick={handleBack}>
                                    <span className={styles.backBtnTxt}>Back</span>
                                    <IoArrowBackCircleOutline style={{color: '#04A0BC',fontSize: '20px'}} />
                                </div>
